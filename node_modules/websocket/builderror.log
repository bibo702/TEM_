...
gyp ERR! stack Error: Command failed: C:\Users\habib.selmane\AppData\Local\Programs\Python\Python37-32\python.EXE -c import sys; print "%s.%s.%s" % sys.version_info[:3];
